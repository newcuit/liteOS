...
/**************************************************************************************
* TypeName       : module_lowpower_t()
* Description    : 驱动进入低功耗模式类型
* EntryParameter : mode :sleep or suspend 休眠的模式
* ReturnValue    : 返回错误码
**************************************************************************************/
typedef int32_t (*module_lowpower_t)(uint8_t);
