...
/**************************************************************************************
* FunctionName   : sorftimer_set_privdata()
* Description    : 设置私有数据
* EntryParameter : timer,定时器指针
* ReturnValue    : None
**************************************************************************************/
void sorftimer_set_privdata(softimer_t timer, void *p)
{
    vTimerSetTimerID(timer, p);
}

/**************************************************************************************
* FunctionName   : sorftimer_get_privdata()
* Description    : 获取私有数据
* EntryParameter : timer,定时器指针
* ReturnValue    : None
**************************************************************************************/
void* sorftimer_get_privdata(softimer_t timer)
{
...
* ReturnValue    : 返回定时器指针, NULL,失败
**************************************************************************************/
softimer_t __default softimer_create(softimer_handle_t handle, uint8_t reload, uint16_t ms)
{
    (void)handle;(void)reload;(void)ms;
    return NULL;
}
...
* ReturnValue    : 返回错误码
**************************************************************************************/
int8_t __default softimer_start(softimer_t timer, uint8_t isr)
{
    (void)timer;(void)isr;
    return 0;
}
...
* ReturnValue    : 返回定时器指针, NULL,失败
**************************************************************************************/
softimer_t __default softimer_fstart(softimer_handle_t handle, uint8_t reload, uint16_t ms)
{
    (void)handle;(void)reload;(void)ms;
    return NULL;
}
...
* ReturnValue    : 返回错误码
**************************************************************************************/
int8_t __default softimer_stop(softimer_t timer, uint8_t isr)
{
    (void)timer;(void)isr;
    return 0;
}
...
* ReturnValue    : 返回错误码
**************************************************************************************/
int8_t __default softimer_reset(softimer_t timer, uint8_t isr)
{
    (void)timer;(void)isr;
    return 0;
}
...
* ReturnValue    : None
**************************************************************************************/
void __default sorftimer_delete(softimer_t timer)
{
    (void)timer;
}
...
* ReturnValue    : None
**************************************************************************************/
void __default sorftimer_set_privdata(softimer_t timer, void *p)
{
    (void)timer;
}
...
* ReturnValue    : None
**************************************************************************************/
void* __default sorftimer_get_privdata(softimer_t timer)
{
    (void)timer;
    return NULL;
}
